...
OUTPUT_PATH = "data/power/query/power_table3_predict.csv"


def build_power_table3_predict(test_time):
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        raise ValueError("請從 main_power.py 傳入 test_time")
    test_time = int(sys.argv[1])
    build_power_table3_predict(test_time)