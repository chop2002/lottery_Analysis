...
TABLE1 = "data/power/query/power_table1_latest5.csv"
TABLE2 = "data/power/query/power_table2_lookup.csv"
WEIGHT_TABLE = "data/power/query/power_weight_table.csv"
TABLE3 = "data/power/query/power_table3_predict.csv"
HYBRID_TABLE = "data/power/query/power_table4_hybrid.csv"
HYBRID_WEIGHTED_PREDICT = "data/power/query/power_table3_predict_hybrid_weighted.csv"

OUTPUT_DIR = "data/power/output"


def export_power_excel():
    ...
    filename = f"power_report_{now_str}.xlsx"
